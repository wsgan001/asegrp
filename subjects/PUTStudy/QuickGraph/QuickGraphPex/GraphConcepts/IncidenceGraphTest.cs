...
namespace QuickGraphNUnit.GraphConcepts
{
    ...
    [PexClass]
    public partial class GenericAdjacencyGraphTest
	{
        ...
        /// There is no test code involved, so does not take any time
		public void TestOutDegree([PexAssumeUnderTest]AdjacencyGraph g)
		{		
	...
	[TestFixture]
    public partial class IncidenceAdjacencyGraphTest : GenericAdjacencyGraphTest
	{
		[SetUp]
		public void Init()
		{
	...
	[TestFixture]
    public partial class BidirectionaleAdjacencyGraphTest : GenericAdjacencyGraphTest
	{
		[SetUp]
		public void Init()
		{

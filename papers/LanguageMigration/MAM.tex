...
can be developed for automatic migration of projects from one
...
mined API mapping relations assist in migration of projects from
...
errors and 43.0\% defects during migration of projects with an
existing migration tool, called Java2CSharp. The reduction in
compilation errors and defects is due to our new mined mapping
relations that are not available with the existing migration
tool.

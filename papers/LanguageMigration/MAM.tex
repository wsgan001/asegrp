...
is a tedious and error-prone task. In contrast, automatic translation
...
These mined API mapping relations assist in translation of projects
from one language to another. Based on our approach,
...
results also show that mined API mapping relations reduce 54.4\% compilation
errors in translated projects of the Java2CSharp tool as our
mappings include relations that do not exist in language

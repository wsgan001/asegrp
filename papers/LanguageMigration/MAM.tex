...
companies often have to develop different versions of their projects
...
with the APIs of the other language. In this paper, we propose a
novel approach that mines API mapping relations from API client
code. Our approach accepts a set of projects with versions in two
languages and mines API mapping relations based on how APIs are used
by the two versions. These mined API mapping relations assist in
...
mapping relations reduce 54.4\% compilation errors in translated
projects of the Java2CSharp tool as our mappings include relations
that do not exist in language migration tools such as Java2CSharp.
\end{abstract}

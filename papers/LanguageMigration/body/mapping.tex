...
is many-to-many. For example, the \CodeIn{java.util.ArrayList} class
of Java is mapped to either \CodeIn{System.Collections.ArrayList}
\textbf{or} \CodeIn{System.Collections. Generic.List} of C\#,
whereas the \CodeIn{java.lang.System} class of Java is mapped to
...
\CodeIn{java.lang.Sys- tem} is mapped with \CodeIn{System.DataTime}.
At the same time, when client code uses APIs to get environment
settings, \CodeIn{java.lang.Sys- tem} is mapped with
...
constructor and a receiver object for the \CodeIn{exist()} method.

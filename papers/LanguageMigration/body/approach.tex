...
and the method \CodeIn{Main} in C\#, respectively, as their names are quite
similar.
%-----------------------------------------------------------------
...
An API transformation graph of a client code method $m$ is a directed graph
...
merged API methods of the \CodeIn{java.io.File.exists()} as all three
merged API methods include the method named \CodeIn{exists}.

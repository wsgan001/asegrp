...
is called through \CodeIn{file}, we call \CodeIn{file} as a related
variable of \CodeIn{exists()}. To translate this code snippet, a
translation tool needs to know mapping relations of API class to
translate the variable \CodeIn{file} to C\#. In addition, a
translation tool needs to know how to call API methods to use the
variable and the input (``\CodeIn{test}'') to produce the exactly
same output.

...
We conducted all the experiments on a PC with an Intel Qual CPU @
...
CSharp2Java maps \CodeIn{java.util. Set} to
...
\CodeIn{java.awt} for its GUI. The mapping files of CSharp2Java

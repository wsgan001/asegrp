...
This item describes the mapping relation between \CodeIn{java.math. BigDecimal} of Java and \CodeIn{System.Decimal} of C\#, and also describes the mapping relation between the \CodeIn{multiply}
method and the \CodeIn{Multiply} method. For the two API methods, the pattern

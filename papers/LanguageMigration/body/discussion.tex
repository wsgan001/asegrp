...
that it is feasible to use the internet-scale code available on the
web as subjects for mining with the help of code search engines such
as Google code
search\footnote{\url{http://www.google.com/codesearch}}. In future
work, we plan to leverage such search engines to mine richer API
mapping.

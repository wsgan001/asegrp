...
After merging API methods \CodeIn{method1} and \CodeIn{method2},
if our algorithm still not able to map the merged API methods with an API method in the
other language, our algorithm attempts to merge \CodeIn{method3} rather than
\CodeIn{method4}, which could be a possible candidate for mining

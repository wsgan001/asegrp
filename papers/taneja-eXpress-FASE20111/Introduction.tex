...
Fifth, we conduct extensive experiments to evaluate our approach.}} \CodeIn{eXpress} and its implementation that uses DSE to detect behavioral differences based on the notion of the PIE model.
...
\textbf{\CodeIn{eXpress} prunes paths that cannot help in achieving conditions E, I, and P.
In addition, \CodeIn{eXpress} prioritizes paths so that condition I can be achieved efficiently and effectively

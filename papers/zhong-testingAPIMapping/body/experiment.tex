...
\begin {tabular} {|c|r|r|r|r|r|c|c|}
 \hline
\multirow{2}*[-2pt]{\textbf{Tool}}
& \multicolumn{2}{|c|}{\textbf{Passed}} & \multicolumn{2}{|c|}{\textbf{Failed}}& \multicolumn{2}{|c|}{\textbf{Error}} \\\cline{2-7}  &  \textbf{M}& \textbf{\%} &  \textbf{M}& \textbf{\%}&  \textbf{M}& {\%}\\
\hline

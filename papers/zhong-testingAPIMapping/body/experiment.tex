...
\item How many behavioral differences are effectively detected by  by generating C\# test cases for testing Java code (Section~\ref{sec:evaluation:sequence})?\vspace*{-1.8ex}

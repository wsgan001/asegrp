...
\item How many behavioral differences of API elements are effectively detected by generating C\# test cases for Java code (Section~\ref{sec:evaluation:single})?\vspace*{-1.8ex}
...
\item How many behavioral differences of API elements are effectively detected by generating Java test cases for C\# code (Section~\ref{sec:evaluation:sequence})?\vspace*{-1.8ex}
...
\hline
\end{tabular}\vspace*{-2ex}
\Caption{Results of generating Java test cases for C\# code} \label{table:invocsequence}
\end{SmallOut}\vspace*{-4ex}
\end{table}

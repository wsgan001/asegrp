...
Test coverage is a common criterion to measure the adequacy of test cases~\cite{zhu1997software}. To investigate whether our combination strategy helps achieve better coverage, we conduct an additional experiment on several selected classes. 
\begin{table}[t]
\centering
\begin{SmallOut}
\begin {tabular} {|c|r|r|r|r|r|c|c|}
...
It is quite tricky to extract coverage information of API methods especially in our context where Java API methods are declared by J2SE and most C\# methods are declared by \CodeIn{mscorlib.dll}.
\subsection{Summary}

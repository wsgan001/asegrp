...
Given a translation tool between Java and C\#, TeMAPI generates various test cases to reveal behavioral differences of API mapping relations defined by the tool. Figure~\ref{fig:approach} shows the overview of TeMAPI. TeMAPI generates test cases to test mapping relations both for a single API class (Section~\ref{sec:approach:single}) and for multiple API classes (Section~\ref{sec:approach:sequence}).

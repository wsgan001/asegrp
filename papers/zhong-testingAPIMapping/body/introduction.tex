...
\item A tool implemented for TeMAPI and three evaluations on five popular translation tools. The results show the effectiveness of our approach in detecting behavioral differences of both single mapped API classes and multiple mapped classes from API mapping relations.

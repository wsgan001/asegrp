...
\CodeIn{java.net. DatagramSocket.receive(DatagramPacket)} method in Java into multiple C\# elements as shown in Figure~\ref{fig:codeJLCA}. (3) Detecting behavior differences from existing applications address the problem partially since applications typically use only a small portion of API elements.

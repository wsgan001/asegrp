...
This evaluation focuses on the effectiveness of our approach to extract API mapping relations from both open source tools and closed source tools. The results are useful for subsequence steps, and also to show the effectiveness of existing translation tools. For Java-to-C\# tools, TeMAPI first synthesized wrapper methods for all classes of J2SE 6.0\footnote{\url{http://java.sun.com/javase/6/docs/api/}}. Most classes in J2SE support both generic programming and non-generic programming (\emph{e.g.}, \CodeIn{java.util.ArrayList}). During synthesizing, our approach focuses on only non-generic programming as described in Section~\ref{sec:approach:wrapper}. Table~\ref{table:java2csharp} shows the translation results. Column ``Type'' lists types of synthesized methods, and Row ``Total'' denotes the sum of all methods. Columns ``Java2CSharp'', ``JLCA'', and ``sharpen'' list the translation numbers of translated wrapper methods without compilation errors for each tool, respectively.
\begin{table}[t]
\centering
\begin{SmallOut}
...
\hline
getters of static fields      &   237 &  3,744 &  47 \\
\hline
setters of static fields      & 0     & 0      & 0  \\
\hline
getters of non-static fields  &  0    &   121  &  0  \\
\hline
setters of non-static fields  &  0    &   79   &  0   \\
\hline
static methods                &  97   &  198  &  26  \\
\hline
non-static methods            & 3,589 &  39,536& 1,112  \\
\hline
\multicolumn{1}{|c|}{Total}   & 3,923 & 43,678 & 1,185\\
\hline
...
\hline
getters of static fields      &  1    &  3     \\
\hline
setters of static fields      &   0    &  0       \\
\hline
getters of non-static fields  &   0    &  0    \\
\hline
setters of non-static fields  &   0    &  0    \\
\hline
static methods                &   4    &  6  \\
\hline
non-static methods            &  94    &  387     \\
\hline
\multicolumn{1}{|c|}{Total}   & 99     &  396 \\
\hline
\end{tabular}%\vspace*{-2ex}
...
\begin{figure}[t]
\centering
\includegraphics[scale=0.4,clip]{figure/pex-percent.eps}\vspace*{-2ex}
 \caption{Distribution of found unique behavioral differences with Pex}\vspace*{-2ex}
...
\begin{figure}[t]
\centering
\includegraphics[scale=0.4,clip]{figure/randoop-percent.eps}\vspace*{-2ex}
 \caption{Distribution of found behavioral differences with Randoop}\vspace*{-2ex}
...
The \CodeIn{var0.AbbreviatedMonthNames=var16} statement throws \CodeIn{InvalidOperation- Exception} since a constant value is assigned to \CodeIn{var0}.

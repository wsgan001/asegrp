...
\begin {tabular} {|l|r|r|r|r|r|r|r|}
 \hline
\multicolumn{1}{|c}{\multirow{2}*[-2pt]{\textbf{Type}}}&
\multicolumn{1}{|c}{\multirow{2}*[-2pt]{\textbf{Number}}}
& \multicolumn{2}{|c|}{\textbf{Java2CSharp}} & \multicolumn{2}{|c|}{\textbf{JLCA}}& \multicolumn{2}{|c|}{\textbf{Sharpen}} \\\cline{3-8} &  &  \multicolumn{1}{c}{\textbf{M}}& \multicolumn{1}{|c}{\textbf{\%}} &  \multicolumn{1}{|c}{\textbf{M}}& \multicolumn{1}{|c}{\textbf{\%}}&  \multicolumn{1}{|c}{\textbf{M}}& \multicolumn{1}{|c|}{\textbf{\%}}\\
\hline\hline
...
\multicolumn{1}{|c}{\multirow{2}*[-2pt]{\textbf{Type}}}&
\multicolumn{1}{|c}{\multirow{2}*[-2pt]{\textbf{Number}}}
& \multicolumn{2}{|c|}{\textbf{Net2Java}} & \multicolumn{2}{|c|}{\textbf{Converter}}\\\cline{3-6} &  &  \multicolumn{1}{c}{\textbf{M}}& \multicolumn{1}{|c}{\textbf{\%}} &  \multicolumn{1}{|c}{\textbf{M}}& \multicolumn{1}{|c|}{\textbf{\%}}\\
\hline\hline
...
\hline\hline
\multicolumn{1}{|c|}{Total} &19,4835& 99   &  0.1\% & 396 & 0.2\%\\
\hline
\end{tabular}%\vspace*{-2ex}
\Caption{Translation results of wrapper methods for C\#-to-Java tools} \label{table:csharp2java}
...
\Caption{Translation results of wrapper methods for Java-to-C\# tools at package levels} \label{table:package}
...
We find that implementers of API libraries may have different understandings for mapped API methods in different languages. Two such examples are shown in Section~\ref{sec:approach:single} (\emph{i.e.}, the \CodeIn{capacity()} method and the \CodeIn{length()} method). In some cases, such differences reflect different natures between languages. For example, we find that Java considers ``\CodeIn{\textbackslash}'' as existing directories, but  C\# considers it not.

In some other cases, such differences can indicate defects in translation tools. For example, Java2CSharp translates the \CodeIn{Character.isJavaIdentifierPart(char)} method in Java to the \CodeIn{ILOG.J2CsMap\-ping.Util.Character.Is\-CSharp\-IdentifierPart(char)} method in C\#. Given an input ``\CodeIn{\textbackslash0}'', the Java method returns \CodeIn{true}, but the C\# method returns \CodeIn{false}. As another example, Java2CSharp translates the \CodeIn{java.lang.Integer.toHexString(int)} method in Java to the \CodeIn{ILOG.J2CsMapping.Util.IlNumber.To\-String(int,16)} method in C\#.
The two translated C\# methods can return different values. In particular, given an integer whose value is -2147483648, the Java method returns ``80000000'', but the C\# method returns ``\textbackslash080000000''. The preceding two behavioral differences were confirmed as defects by developers of Java2CSharp after we reported them to its developers.
...
\begin {tabular} {|l|r|r|r|r|r|c|c|}
 \hline
\multicolumn{1}{|c|}{\multirow{2}*[-2pt]{\textbf{Name}}}
& \multirow{2}*[-2pt]{\textbf{Number}} & \multicolumn{2}{|c|}{\textbf{E-Tests}}& \multicolumn{2}{|c|}{\textbf{A-Tests}} \\\cline{3-6}  &  & \multicolumn{1}{c|}{\textbf{M}}& \multicolumn{1}{c|}{\textbf{\%}} &  \multicolumn{1}{c|}{\textbf{M}}& \multicolumn{1}{c|}{\textbf{\%}}\\
\hline\hline
...
\hline\hline
\multicolumn{1}{|c|}{Total} &  52,336  &  15,153 & 29.0\% &11,099 & 21.2\%  \\
\hline
\end{tabular}%\vspace*{-2ex}
\Caption{Testing results of generating C\# test cases from Pex and translating them into Java code} \label{table:singleinvoc}
\end{SmallOut}%\vspace*{-6ex}
\end{table*}


We find that two mapped API methods can throw exceptions that are not mapped. For example, the \CodeIn{java.lang. StringBuffer.insert(int,char)} method in Java throws \CodeIn{ArrayIndexOut\-of\-BoundsException} when indexes are out of bounds. Java2CSharp translates the method in Java to the \CodeIn{System.Text.StringBuilder.Insert(int,char)} method in C\# that throws \CodeIn{ArgumentOut\-Of\-RangeException} when indexes are out of bounds. As Java2CSharp translates \CodeIn{ArrayIndexOutofBoundsExcep\-tion} in Java to \CodeIn{Index\-Out\-Of\-RangeException} in C\#, the mapped C\# method fails to catch exceptions when indexes are out of bounds.
...
\begin {tabular} {|l|r|r|r|r|r|r|r|r|r|r|}
 \hline
\multicolumn{1}{|c}{\multirow{2}*[-2pt]{\textbf{Name}}}
& \multicolumn{2}{|c|}{\textbf{Java2CSharp}} & \multicolumn{2}{|c|}{\textbf{JLCA}}& \multicolumn{2}{|c|}{\textbf{Sharpen}} \\\cline{2-7} &  \multicolumn{1}{c}{\textbf{R}}&  \multicolumn{1}{|c}{\textbf{\%}} &   \multicolumn{1}{|c}{\textbf{R}}& \multicolumn{1}{|c}{\textbf{\%}} & \multicolumn{1}{|c}{\textbf{R}}&  \multicolumn{1}{|c|}{\textbf{\%}}\\
\hline\hline
...
\begin {tabular} {|l|r|r|r|r|r|c|c|}
 \hline
\multicolumn{1}{|c|}{\multirow{2}*[-2pt]{\textbf{Name}}}& \multirow{2}*[-2pt]{\textbf{Method}} & \multicolumn{1}{c|}{\multirow{2}*[-2pt]{\textbf{Java}}}
...
\hline\hline
\multicolumn{1}{|c|}{Total} &  9,642 & 45,547& 4,974  &  2,902 & 58.3\% \\
\hline
\end{tabular}%\vspace*{-2ex}
\Caption{Testing results of generating Java test cases from Randoop and translating them into C\# code} %\vspace*{-6ex}
...
Since the preceding two Java API classes are related through inheritance, the test case passes. JLCA translates the Java test case to a C\# test case as follows:
...
We find that random invocation sequences can violate specifications of API libraries. One type of such specifications is described in our previous work~\citep{zhong09:inferring}: closed resources should not be manipulated. Java sometimes allows programmers to violate such specifications although return values can be meaningless. One such example is shown in Section~\ref{sec:example} (\emph{i.e.}, the \CodeIn{test413} test case). Besides invocation sequences that are related to specifications, we find that field accessibility also leads to failures of test cases. For example, a generated Java test case is as follows:
...
In the preceding translated test case, the last statement throws \CodeIn{InvalidOperationException} since a constant value is already assigned to \CodeIn{var0} in a previous line.

\textbf{Implication 8:} Legal invocation sequences can become illegal after translation, since the target language may be more strict to check invocation sequences, and other factors such as field accessibility can also cause behavioral differences. In most of such cases, programmers should deal with these differences themselves.

The remaining 3.0\% test cases failed, since translation tools translate API elements in Java to C\# API elements that are not implemented yet. For example, Java2CSharp translates the \CodeIn{java.io.ObjectOutputStream} class in Java to the \CodeIn{ILOG.J2CsMapping.IO.IlObjectOut\-putStream} class in C\# that is not yet implemented, and such translations lead to \CodeIn{NotImplementException}. The evaluation in Section~\ref{sec:evaluation:single} does not detect this difference since the specific exception is not mapped.

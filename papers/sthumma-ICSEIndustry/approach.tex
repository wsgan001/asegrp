...
The \CodeIn{OUT} parameter is the return value of the method \CodeIn{Capture.Index}. 
These \CodeIn{OUT} parameters are later used to generate test assertions in regression tests (Section~\ref{sec:explore}). 
...
\CodeIn{PUT2} at the level of MSIL instructions. In this example, 
our approach considers \CodeIn{PUT2} as a duplicate of \CodeIn{PUT1}

...
can be used to automatically generate a small set of conventional unit tests
...
dynamic symbolic execution engine. However, our approach is not specific 
to Pex, and can be used with any other test input generation engine.

A major advantage of PUTs compared to conventional unit tests is that test data is automatically

...
selection approach.% based on the mined common operational models.
...
we investigate three main research questions: %\vspace{-0.1in}
\begin{itemize}
\item
...
\textbf{Regression Test Selection} %/Prioritization/Minimization}

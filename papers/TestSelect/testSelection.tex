...
approach can more effectively reduce the number of tests for result
inspection while revealing most of the faults.
%The experimental results
%show that our approach is effective for test selection.

%% abstract in the submission page
%In automated testing, especially test generation in the absence of
%specifications, a large amount of manual effort is spent on
%test-result inspection. Test selection helps to reduce this effort
%by selecting a small subset of tests that are likely to reveal
%faults. A promising approach is to dynamically mine operational
%models and then select tests that violate them. Existing work mines
%operational models based on dynamic invariant detection. We propose
%to mine common operational models, which are often but not always
%true in all observed traces, from a (potentially large) set of
%unverified tests. Specifically, our approach collects branch
%coverage and data value bounds at runtime and then mines implication
%relationships between branches and constraints of data values as
%potential operational models after running all the tests. Our
%approach then selects tests that violate the mined common
%operational models for result inspection. Experimental results show
...
\begin{figure*}
%  \centering
  \subfigure[Results for the \emph{Siemens} suite]{
    \label{fig:all:a} %% label for first subfigure
    %\includegraphics{figs/plotExps_siemens.eps}}
    \includegraphics[width=0.33\textwidth]{figs/plotExps_siemens_large.eps}}
%  \hspace{0.5in}
  \subfigure[Results for the \emph{Space} program]{
    \label{fig:all:b} %% label for second subfigure
    \includegraphics[width=0.328\textwidth]{figs/plotExps_space_large.eps}}
  \subfigure[Results for the \emph{grep} program]{
    \label{fig:all:c} %% label for second subfigure
    \includegraphics[width=0.34\textwidth]{figs/plotExps_grep_large.eps}}
  \caption{Results of all the faults}
  \label{fig:all} %% label for entire figure
\end{figure*}
...
%  \centering
  \subfigure[Results for the \emph{Siemens} suite]{
    \label{fig:nontrivial:a} %% label for first subfigure
    %\includegraphics{figs/plotExps_diffi_siemens.eps}}
    \includegraphics[width=0.33\textwidth]{figs/plotExps_diffi5_siemens_large.eps}}
%  \hspace{0.5in}
  \subfigure[Results for the \emph{Space} program]{
    \label{fig:nontrivial:b} %% label for second subfigure
    \includegraphics[width=0.328\textwidth]{figs/plotExps_diffi5_space_large.eps}}
  \subfigure[Results for the \emph{grep} program]{
    \label{fig:nontrivial:c} %% label for second subfigure
    \includegraphics[width=0.34\textwidth]{figs/plotExps_diffi5_grep_large.eps}}
  \caption{Results of the nontrivial faults}
  \label{fig:nontrivial} %% label for entire figure
\end{figure*}
...
\hline Program   & LOC & \#Tests & Our  & Coverage & Clustering   \\
& & & \footnotesize{Approach} &  &  \\
...
\hline  \emph{Siemens} suite   &   400 &   3115    &   2.6 &   0.4 &   150.2   \\
\hline  \emph{Space}   &   9564    &   13585   &   598.8   &   5.4 &   1364    \\
\hline  \emph{grep}    &   13358  &   809 &   92.9    &   4.9 &   6.8 \\

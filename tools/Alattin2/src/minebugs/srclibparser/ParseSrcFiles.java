...
public class ParseSrcFiles {
	...
	public ParseSrcFiles(String srcDir)
	{
		try
		{
			this.mainSrcDir = srcDir;
	...
	{
		this.ijp = ijp;
		RepositoryAnalyzer.getInstance().setCurrentJProject(ijp);
	...
	//CAUTION: Code duplicated in RepositoryAnalyzer

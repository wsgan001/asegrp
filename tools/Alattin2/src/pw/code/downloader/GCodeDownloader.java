...
public class GCodeDownloader {
	...
	{
		CommonConstants.MAX_THREAD_CNT = 15;
	...
	private synchronized void addToLists(CodeSearchEntry cseObj, List<String> URLLinkList, List<String> localFileNameList, String objPackageName)
	{
		...
		try
		{
			...
			RepositoryAnalyzer.getInstance().getCodeSampleIDToPackageMapper().put(relatedClsName + fileNameWithLang, objPackageName);
			fileCnt++;
			RepositoryAnalyzer.numDownloadedCodeSamples++;
		}

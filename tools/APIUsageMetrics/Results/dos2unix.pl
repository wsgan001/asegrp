...
# $Id: dos2unix.pl,v 2.9 2006/04/07 10:01:03 jaalto Exp $
#
#  File id
#
...
sub Initialize ()
{
    ...
    $FILE_ID  = q$Id: dos2unix.pl,v 2.9 2006/04/07 10:01:03 jaalto Exp $;
...
Copyright (C) 2000-2006 Jari Aalto. All rights reserved.
